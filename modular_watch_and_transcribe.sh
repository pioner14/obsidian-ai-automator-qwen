...
LOG_FILE="$(dirname "$0")/.modular_watch_and_transcribe.log"
...
# Запускаем Python-скрипт мониторинга для новой архитектуры
source venv/bin/activate && python "$(dirname "$0")"/obsidian_ai_automator/monitoring/file_watcher.py