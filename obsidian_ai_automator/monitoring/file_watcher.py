...
OBSIDIAN_TRANSCRIBE_SCRIPT = os.path.join(os.path.dirname(os.path.abspath(__file__)), "obsidian-ai-transcribe-modular.sh")
LOG_FILE = os.path.join(os.path.dirname(os.path.abspath(__file__)), ".modular_inotify_monitor.log")
# --------------------
...
class NewFileHandler(FileSystemEventHandler):
    ...
    def process_file(self, file_path):
        ...
        # Убедитесь, что obsidian-ai-transcribe-modular.sh имеет права на выполнение
